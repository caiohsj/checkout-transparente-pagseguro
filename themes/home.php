...
<html lang="pt-br">
    ...
    <body>
            ...
            <form method="post" class="mt-3" id="formCheckout">
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="inputName" name="senderName" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="inputEmail4">Email</label>
                        <input type="email" class="form-control" id="inputEmail4" name="senderEmail" required>
                    </div>
                    <div class="form-group col-md-4">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="inputCity" name="shippingAddressCity" required>
                    </div>
                    <div class="form-group col-md-2">
                        <label for="inputState">Estado (Sigla)</label>
                ...
                <button onclick="" type="submit" class="btn btn-primary d-none" id="buttonBoleto">Pagar com boleto</button>
        ...
        <script src="{#BASE_URL#}/themes/js/pagseguro-checkout-transparente.js"></script>
