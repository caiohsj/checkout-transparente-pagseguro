            ...
            <form method="post" class="mt-3" id="formCheckout">
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="inputName" name="senderName" >
                    </div>
                    <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" class="form-control" id="inputCpf" name="senderCPF" onfocus="getSenderHash();">
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-1">
                        ...
                        <input type="number" class="form-control" id="inputAddressNumber" placeholder="123" name="shippingAddressNumber">
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            <select class="form-control" id="selectInstallments" name="installment">
                                <!-- <option value="1/100.00">1x de R$ 100.00 -  total R$ 100.00</option> -->
                            </select>
                        </div>
                    </div>
                </div>
